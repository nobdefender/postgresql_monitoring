...
namespace Monitoring.Postgresql.Migrations
{
    ...
    [Migration("20231104015430_AddForeignKeyToUserToAction")]
    partial class AddForeignKeyToUserToAction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Monitoring.Posgresql.Infrastructure.Models.Bindings.UserToActionDbModel", b =>
                {
                    ...
                    b.HasOne("Monitoring.Posgresql.Infrastructure.Models.Auth.UserDbModel", "UserDbModel")
                        .WithMany("UserToActionDbModels")
